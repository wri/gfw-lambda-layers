...
module "py310_rasterio_143" {
  ...
  runtime        = "python3.10"
  layer_path     = "${path.root}/layers/python3.10/rasterio_1.4.3/"
}
...
module "py312_geopandas_112" {
  source         = "./modules/lambda_layer"
  bucket         = local.core.gfw_pipelines_bucket_name
  name           = "geopandas"
  module_version = "1.1.2"
  runtime        = "python3.12"
  layer_path     = "${path.root}/layers/python3.12/geopandas_1.1.2/"
}

module "py312_mercantile_121" {
  source         = "./modules/lambda_layer"
  bucket         = local.core.gfw_pipelines_bucket_name
  name           = "mercantile"
  module_version = "1.2.1"
  runtime        = "python3.12"
  layer_path     = "${path.root}/layers/python3.12/mercantile_1.2.1/"
}

module "py312_numpy_226" {
  source         = "./modules/lambda_layer"
  bucket         = local.core.gfw_pipelines_bucket_name
  name           = "numpy"
  module_version = "2.2.6"
...
module "py312_pillow_1211" {
  ...
  module_version = "12.1.1"
  runtime        = "python3.12"
  layer_path     = "${path.root}/layers/python3.12/pillow_12.1.1/"
}

module "py312_rasterio_151" {
  source         = "./modules/lambda_layer"
  bucket         = local.core.gfw_pipelines_bucket_name
  name           = "rasterio"
  module_version = "1.5.1"
  runtime        = "python3.12"
  layer_path     = "${path.root}/layers/python3.12/rasterio_1.5.1/"
}

module "py312_shapely_212" {
  source         = "./modules/lambda_layer"
  bucket         = local.core.gfw_pipelines_bucket_name
  name           = "shapely"
  module_version = "2.1.2"
  runtime        = "python3.12"
  name_suffix    = local.name_suffix
  layer_path     = "${path.root}/layers/python3.12/shapely_2.1.2/"
}
